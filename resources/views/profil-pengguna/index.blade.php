            ...
            <div class="card-body text-center pt-5 pb-5 d-flex flex-column justify-content-between">
                <div>
                    <div class="mb-4 d-flex justify-content-center">
                        @if($user->foto)
                            <img src="{{ asset('storage/' . $user->foto) }}" alt="{{ $user->nama_lengkap }}" class="rounded-circle shadow" style="width: 120px; height: 120px; object-fit: cover; border: 4px solid #e9ecef;">
                        @else
                            <div style="width: 120px; height: 120px; border-radius: 50%; background-color: #f8f9fa; border: 4px solid #e9ecef; display: flex; align-items: center; justify-content: center; font-size: 3.5rem; color: #1e3a8a;">
                    ...
                    <p class="text-muted mb-3">
                        ...
                        @elseif($user->role === 'anggota')
                            <span class="badge badge-success px-4 py-2 rounded-pill" style="font-size: 0.9rem;"><i class="fas fa-check-circle mr-1"></i> Anggota Paskibra</span>
                        @else
                ...
                <div class="mt-4 pt-3 border-top d-flex flex-column gap-2">
                    <a href="{{ route('pengaturan.index') }}" class="btn btn-outline-primary rounded-pill font-weight-bold mb-2">
                    ...
                    @if($user->role === 'anggota' || ($user->formulirPendaftaran && $user->formulirPendaftaran->status_kelulusan === 'LOLOS'))
                        <button type="button" class="btn btn-warning rounded-pill font-weight-bold text-dark shadow-sm" data-toggle="modal" data-target="#ktaModal">
    ...
    <div class="col-lg-8 col-md-7 mb-4">
        <div class="card shadow-sm border-0" style="border-radius: 1rem;">
            ...
            <div class="card-body p-4">
                ...
                <div class="p-3 mb-4 rounded border" style="background: linear-gradient(135deg, #f0fdf4 0%, #dcfce7 100%); border-color: #86efac !important;">
                    <div class="d-flex justify-content-between align-items-center flex-wrap">
                        <div>
                            ...
                            <h6 class="font-weight-bold text-dark mb-1">Penerimaan Anggota Paskibra Periode {{ $fp->tahun_periode }}</h6>
                            <p class="text-muted small mb-0"><i class="fas fa-certificate text-success mr-1"></i> Selamat! Dinyatakan lulus seluruh tahapan seleksi fisik & akademik.</p>
                        </div>
                        ...
                        <div class="text-right mt-3 mt-md-0">
                            ...
                            <span class="font-weight-bold text-success" style="font-size: 1.5rem;">{{ number_format($totalScore, 2) }}</span>
                        ...
                        @foreach($kriterias as $k)
                            ...
                            <div class="col-md-3 col-sm-6 mb-2">
                                <div class="p-2 bg-white rounded border shadow-sm">
                                    <small class="text-muted d-block text-truncate" style="font-size: 0.75rem; font-weight: 600;">{{ $k->nama }}</small>
                                    <div class="d-flex justify-content-between align-items-center mt-1">
                                        <span class="font-weight-bold text-dark" style="font-size: 0.95rem;">{{ number_format($nilaiK, 1) }}</span>
                                        @if($hasilK)
                                            <span class="badge {{ $isLulusK ? 'badge-success' : 'badge-danger' }}" style="font-size: 0.7rem;">
                ...
                <h6 class="font-weight-bold text-primary mb-3"><i class="fas fa-user mr-2"></i> Biodata Pribadi & Kontak</h6>
                <div class="row mb-3">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-8 text-dark">{{ $fp->tempat_lahir }}, {{ \Carbon\Carbon::parse($fp->tanggal_lahir)->format('d F Y') }}</div>
                </div>
                <div class="row mb-3">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-8 text-dark">
                        <a href="https://wa.me/{{ preg_replace('/[^0-9]/', '', $fp->no_hp) }}" target="_blank" class="text-success text-decoration-none font-weight-bold">
                ...
                <h6 class="font-weight-bold text-primary mb-3"><i class="fas fa-graduation-cap mr-2"></i> Data Sekolah & Fisik</h6>
                <div class="row mb-3">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-8 text-dark"><span class="badge badge-info px-3 py-1 rounded-pill">{{ $fp->opsi_pilihan === 'YA' ? 'Pernah (YA)' : 'Belum (TIDAK)' }}</span></div>
                </div>
                <div class="row mb-3">
                ...
                <h6 class="font-weight-bold text-primary mb-3"><i class="fas fa-users mr-2"></i> Data Orang Tua / Wali</h6>
                <div class="row mb-3">
                ...
                <h6 class="font-weight-bold text-primary mb-3"><i class="fas fa-file-pdf mr-2"></i> Berkas Dokumen Terlampir</h6>
                <div class="row">
                    <div class="col-md-4 mb-2">
                        <div class="p-3 border rounded bg-light text-center">
                            ...
                            <a href="{{ asset('storage/' . $fp->upload_surat_izin) }}" target="_blank" class="btn btn-sm btn-outline-primary rounded-pill font-weight-bold px-3">
                    ...
                    <div class="col-md-4 mb-2">
                        <div class="p-3 border rounded bg-light text-center">
                            ...
                            <a href="{{ asset('storage/' . $fp->upload_skd) }}" target="_blank" class="btn btn-sm btn-outline-primary rounded-pill font-weight-bold px-3">
                                <i class="fas fa-download mr-1"></i> Unduh / Lihat
                            </a>
                        </div>
                    </div>
                    <div class="col-md-4 mb-2">
                        <div class="p-3 border rounded bg-light text-center">
                            ...
                            <a href="{{ asset('storage/' . $fp->upload_kk) }}" target="_blank" class="btn btn-sm btn-outline-primary rounded-pill font-weight-bold px-3">
                                <i class="fas fa-download mr-1"></i> Unduh / Lihat
                            </a>
                        </div>
                    </div>
        ...
        <div class="modal-content border-0 shadow-lg" style="border-radius: 1.25rem; overflow: hidden;">
            ...
            <div class="modal-body p-4 bg-light text-center">
                ...
                <div id="ktaPrintArea" class="d-flex flex-column align-items-center">
                    ...
                    <div class="kta-card shadow-lg text-left position-relative mb-3" style="width: 480px; max-width: 100%; height: 280px; border-radius: 18px; background: linear-gradient(135deg, #1e1b4b 0%, #312e81 40%, #1e3a8a 100%); color: white; padding: 22px; box-shadow: 0 15px 35px rgba(0,0,0,0.35) !important; border: 2px solid #fbbf24; overflow: hidden;">
                        ...
                        <div class="row align-items-center mt-2">
                            <div class="col-4 text-center">
                                <div class="position-relative d-inline-block">
                                    @if($user->foto)
                                        <img src="{{ asset('storage/' . $user->foto) }}" alt="{{ $user->nama_lengkap }}" class="rounded-circle shadow" style="width: 80px; height: 80px; object-fit: cover; border: 3px solid #fbbf24; margin: 0 auto; display: block;">
                                    @else
                                        <div class="rounded-circle d-flex align-items-center justify-content-center bg-white font-weight-bold shadow" style="width: 80px; height: 80px; font-size: 2rem; color: #1e3a8a; border: 3px solid #fbbf24; margin: 0 auto;">
                                            {{ strtoupper(substr($user->nama_lengkap, 0, 1)) }}
                                        </div>
                                    @endif
                                    <div class="position-absolute bg-success rounded-circle d-flex align-items-center justify-content-center shadow" style="width: 22px; height: 22px; bottom: 2px; right: 2px; border: 2px solid white;">
                                        <i class="fas fa-check text-white" style="font-size: 0.6rem;"></i>
                                    </div>
                                </div>
                                <span class="badge badge-warning text-dark font-weight-bold mt-2 d-block mx-auto" style="font-size: 0.62rem; border-radius: 10px; width: fit-content; padding: 4px 10px;">ANGGOTA RESMI</span>
                            </div>
                            <div class="col-8 pl-1">
                                <h6 class="font-weight-bold text-white mb-1 text-truncate" style="font-size: 1rem; letter-spacing: 0.3px;">
                                    {{ strtoupper($user->nama_lengkap) }}
                                </h6>
                                <p class="mb-1 text-warning font-weight-bold" style="font-size: 0.78rem;">
                                    NO. KTA: KTA-{{ $user->formulirPendaftaran->tahun_periode ?? date('Y') }}/00{{ $user->id }}
                                </p>
                                <div style="font-size: 0.73rem; opacity: 0.95;" class="text-light">
                                    <div class="mb-1"><i class="fas fa-id-badge text-warning mr-1" style="width: 14px;"></i> NISN: <strong>{{ $user->nisn ?? '-' }}</strong></div>
                                    <div class="mb-1 text-truncate"><i class="fas fa-school text-warning mr-1" style="width: 14px;"></i> {{ $user->formulirPendaftaran->asal_sekolah ?? 'SMA Negeri 1 Pontianak' }}</div>
                                    <div><i class="fas fa-calendar-check text-warning mr-1" style="width: 14px;"></i> Angkatan: Tahun {{ $user->formulirPendaftaran->tahun_periode ?? date('Y') }}</div>
                                </div>
                            </div>
                        </div>

                        <!-- KTA Footer -->
                        <div class="position-absolute d-flex justify-content-between align-items-end" style="bottom: 14px; left: 22px; right: 22px;">
                            <small class="text-light" style="font-size: 0.6rem; opacity: 0.8;"><i class="fas fa-shield-alt text-warning mr-1"></i> Card Verification Token Signed</small>
                ...
                <div class="mt-3">
                    <button type="button" onclick="window.print()" class="btn btn-warning font-weight-bold rounded-pill px-4 shadow-sm text-dark">
