        ...
        <div class="auth-card">
            ...
            <div class="auth-form-side">
                <div class="text-center mb-3">
                    <img src="{{ asset('images/logo.webp') }}" alt="Logo" style="width: 50px; margin-bottom: 0.5rem;">
                    ...
                    document.addEventListener('DOMContentLoaded', function () {
                        @if($errors->any())
                            Swal.fire({
                                icon: 'error',
                                title: 'Login gagal',
                                text: 'Silakan periksa NISN/NIP dan password Anda.',
                ...
                <form action="{{ route('login.post') }}" method="POST">
                    ...
                    <!-- NISN Input -->
                    <div class="mb-3">
                        <label for="nisn" class="form-label fw-bold mb-1" style="font-size: 0.85rem; color: #444;">NISN /
                            NIP</label>
                    ...
                    <div class="mb-3">
                        <label for="password" class="form-label fw-bold mb-1"
                            style="font-size: 0.85rem; color: #444;">Password</label>
                    ...
                    <div class="mb-3 d-flex justify-content-between align-items-center">
                        ...
                        <a href="#" class="text-danger text-decoration-none"
                            style="font-size: 0.8rem; font-weight: 600;">Lupa Password?</a>
                    </div>
